<div class="ComponentPanel" id="{{component_name}}">
  ...
  <div class="ButtonsContainer" id="{{component_name}}_buttons">
    <div class="ButtonsColumn">
      ...
      <div class="Button Blue" id="{{component_name}}_tag">Tag</div>
      <div class="Button Blue" id="{{component_name}}_led">LED</div>
    </div>
    <div class="ButtonsColumn">
...
<script>
  ...
  $("div#{{component_name}}_tag").click(function() {
    send_to_server({msg: "COMMAND {{component_name}} tag"});
  });
  $("div#{{component_name}}_show").click(function() {
    send_to_server({msg: "COMMAND {{component_name}} show"});
  });
  $("div#{{component_name}}_led").click(function() {
    send_to_server({msg: "COMMAND {{component_name}} led"});
  });
</script>
