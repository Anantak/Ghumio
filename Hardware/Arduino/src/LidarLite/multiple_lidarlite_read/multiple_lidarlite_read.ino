...
int sensorPins[] = {4,5,4,5}; // Array of pins connected to the sensor Power Enable lines
...
void loop(){
  enableDisableSensor(sensorPins[0]); // Turn on sensor attached to pin 2 and disable all others
  Serial.print(readDistance()); // Read Distance from Sensor
  Serial.print("."); // Print "." to separate readings
  enableDisableSensor(sensorPins[1]); //Turn on sensor attached to pin 3 and disable all others
  Serial.print(readDistance()); // Read Distance from Sensor
  Serial.print("."); // Print "." to separate readings
  enableDisableSensor(sensorPins[2]); // Turn on sensor attached to pin 2 and disable all others
  Serial.print(readDistance()); // Read Distance from Sensor
  Serial.print("."); // Print "." to separate readings
  enableDisableSensor(sensorPins[3]); //Turn on sensor attached to pin 3 and disable all others
  Serial.print(readDistance()); // Read Distance from Sensor
